...
describe FinacleApi::XferTrnAdd::API do
  ...
  describe '#cash_drop' do
    ...
    before do
      ...
      @response = @client.cash_drop('1008810030000203','1008810030000286', 10,
          { :value_dt => "2012-12-12T00:00:00.000",
            :trn_particulars => 'DSB Request',
            :part_trn_rmks => "SR12345",
            :pmt_inst => {
    ...
    it 'returns XferTrnAddResponse' do
      @response[:request].should be_a FinacleApi::XferTrnAdd::Request
      @response[:response].should be_a FinacleApi::XferTrnAdd::ResponseEntity::XferTrnAddResponse
    end
