  ...
  module XferTrnAdd
    module API
      ...
      def cash_drop(debit_account_id, credit_account_id, amount, options={})
        ...
        part_trn_rmks = options.delete(:part_trn_rmks)
        trn_particulars = options.delete(:trn_particulars)
        finacle_request_id = options.delete(:finacle_request_id)
        debit_txn = {
          :acct_id => {
          ...
          :trn_particulars => trn_particulars,
          :part_trn_rmks => part_trn_rmks
        }
        ...
        {:request => req, :response => xfer_trn_response_object(body_hash)}
      end
