...
require 'finacle_api/od_acct_inq/response/gen_ledger_sub_head' 
require 'finacle_api/od_acct_inq/response/acct_stmt_freq' 
module FinacleApi
  module ODAcctInq
    module ResponseEntity
      class ODAcctGenInfo < SerializableObject
